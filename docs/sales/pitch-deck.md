...
### Litter Collection Is Manual, Expensive, and Inconsistent

**The numbers tell the story:**

| The Problem | The Data |
|-------------|----------|
| Global street cleaning spend | **$50-60 billion/year** in labor and equipment |
| Cost per manual litter worker | **$4,660-$6,680/month** (wages + benefits + overhead + supervision) |
| Workers needed per park site | **2-3 workers** to maintain cleanliness across shifts |
| Monthly cost per site (2 workers) | **$9,320-$13,360/month** |
| Labor cost growth | **5-8% annually** -- and accelerating |
| Urbanization trend | **68% of world population** in cities by 2050 (up from 56% today) |

**The pain is real:**

- Chronic labor shortages in sanitation -- cities can't hire enough workers
- Coverage gaps: nights, weekends, holidays, and bad weather leave spaces unattended
- Zero data: no analytics on litter patterns, no route optimization, no performance tracking
- Inconsistent quality: manual collection varies by worker, shift, and day
- Rising costs: minimum wage increases and benefits inflation hit cleaning budgets hardest

**Municipalities and property managers are spending more every year and getting less.**

---

## Slide 3: The Solution

### An Autonomous Robot That Collects Litter 20+ Hours a Day

[PLACEHOLDER: robot hero image -- CleanWalker quadruped walking through a park, picking up a plastic bottle]

**CleanWalker deploys autonomous quadrupedal robots that:**
...
### Purpose-Built for Outdoor Litter Collection

[PLACEHOLDER: robot hero image -- annotated product shot with callouts to key components]

| Specification | Detail |
|---------------|--------|
| **Form factor** | Quadrupedal (4 legs, 12 actuators, 3 DOF per leg) |
| **Weight** | ~30 kg |
...
| **Daily coverage** | 20+ hours autonomous operation (self-charging cycles) |
| **Weatherproofing** | IP54+ rated -- operates in light to moderate rain |
| **Connectivity** | 4G LTE always-on telemetry, no WiFi required |
| **Coverage** | 5-10 acres per robot per day (terrain/litter density dependent) |

[PLACEHOLDER: robot in park -- CleanWalker navigating a public park path alongside pedestrians]
...
### Deploy in Weeks. Autonomous from Day One.

```
┌──────────────┐     ┌──────────────┐     ┌──────────────┐
│  1. DEPLOY   │────▶│  2. OPERATE  │────▶│  3. MANAGE   │
│              │     │              │     │              │
│ Site survey  │     │ Autonomous   │     │ Fleet        │
│ Dock install │     │ patrol &     │     │ dashboard    │
│ Robot config │     │ collection   │     │ Real-time    │
│ Staff train  │     │ Self-charge  │     │ analytics    │
└──────────────┘     └──────────────┘     └──────────────┘
    Week 1-4            24/7/365           Always-on
```

**Step 1: Deploy (Week 1-4)**
- We survey your site and map optimal coverage zones
- Install charging docks (outdoor GFCI, no special infrastructure)
- Configure robots for your terrain and litter patterns
- Train your team on the dashboard

**Step 2: Autonomous Operation (24/7)**
- Robots patrol autonomously, detecting and collecting litter
- AI learns your site's litter patterns and optimizes routes
- Self-docking for charging -- no manual intervention needed
- Operates nights, weekends, holidays, rain

**Step 3: Fleet Dashboard**
- Real-time location tracking and status for every robot
- Litter heatmaps and collection analytics
- Maintenance alerts and performance reports
- API access for integration with your existing systems

[PLACEHOLDER: fleet dashboard screenshot -- map view with robot positions, collection stats, and litter heatmap overlay]

---

## Slide 6: Market Opportunity

### A $3-5 Billion Market with No Commercial Solution Today

| Market Layer | 2025 | 2030 (Projected) |
|-------------|------|-------------------|
| **TAM** -- Autonomous outdoor litter collection globally | **$3-5 billion** | **$8-12 billion** |
| **SAM** -- Developed markets where cities have budget and infrastructure for autonomous solutions | **$1.0-1.7 billion** | **$2.6-4.3 billion** |
| **SOM** -- CleanWalker's realistic 5-year capture | -- | **$160-400 million cumulative** |

**Market sizing breakdown (SAM):**

| Segment | 2025 | 2030 |
|---------|------|------|
| Urban public space litter collection | $500M-$800M | $1.5B-$2.5B |
| Beach and park cleaning | $200M-$400M | $500M-$800M |
| Campus and commercial grounds | $300M-$500M | $600M-$1.0B |

**Why now?**

- **Labor crisis:** Cleaning worker wages rising 5-8% annually; chronic hiring shortages
- **Technology inflection:** AI perception (YOLO), edge compute (Jetson), and battery tech have reached cost-effectiveness thresholds for outdoor robotics
- **Regulatory clarity:** EU Machinery Regulation 2023/1230 (effective January 2027) explicitly covers autonomous outdoor robots for the first time
- **Proven demand:** Veolia (EUR 45B revenue) already trialed quadrupedal litter-collecting robots at Bondi Beach, Sydney -- validating market interest at the highest level
- **Cleaning robot market growing 18-25% CAGR** -- outdoor segment at 10.9% CAGR to $4.56B by 2032
...
### AI Perception + Quadruped Locomotion + Fleet Intelligence

[PLACEHOLDER: technology architecture diagram showing perception, planning, locomotion, and cloud layers]

**Perception (See)**
- YOLO-based deep learning litter detection -- trained on 25,000+ annotated images
- OAK-D Pro stereo depth camera with on-device neural network inference (4 TOPS)
- RPLidar A1 for 360-degree obstacle detection and safety
- Detects and classifies: bottles, cans, wrappers, cups, cigarette butts, paper
- Continuous model improvement via OTA updates from field data

**Navigation (Plan)**
- Visual-inertial odometry (VIO) for SLAM -- no GPS dependency for local navigation
- ROS2 Nav2 stack for path planning and obstacle avoidance
- Geofenced operation zones with configurable patrol routes
- Pedestrian detection and safety-first behavior

**Quadruped Locomotion (Move)**
- 12 CAN-bus actuators with field-oriented control
- Terrain-adaptive gait: grass, gravel, sand, cobblestone, slopes, curbs
- Dynamic balance and recovery -- handles bumps, uneven ground, inclines
- Weatherproof (IP54+) for year-round outdoor operation
...
- Cloud-based dashboard with real-time telemetry via 4G LTE
- Multi-robot coordination and route optimization
- Automated maintenance scheduling and alerts
- Performance analytics and litter pattern reporting
- API for integration with existing municipal systems

---

## Slide 10: Go-to-Market

### Phase 1 EU + UAE, Phase 2 UK + AU + SG, Phase 3 US + JP + KR

**Phase 1: Proof of Concept (2026-2027) -- Northern Europe + UAE**

| Market | Strategy | Key Partners |
|--------|----------|-------------|
| **Netherlands** (Amsterdam/Rotterdam) | Pilot with progressive municipality; EU regulatory pathway | Direct municipal or local waste company |
| **UAE** (Dubai/Sharjah) | Pilot with BEEAH; showcase at GITEX; regulatory sandbox | BEEAH Group (smart city DNA, MENA gateway) |
| **Germany** (Munich/Berlin) | IFAT 2026 launch; pilot with municipal partner | Remondis or BSR Berlin |

**Phase 2: Scale in Core Markets (2028-2029) -- UK + Australia + Singapore**

| Market | Strategy | Key Partners |
|--------|----------|-------------|
| **UK** | Scale via waste company partnerships; ISWA 2026 relationships | Biffa (GBP 2.1B), SUEZ UK |
| **Australia** | Build on Veolia's Bondi Beach quadruped trial | Cleanaway (AUD 3.85B), Veolia ANZ |
| **Singapore** | National Robotics Programme; NEA partnership | Direct or via Veolia/SUEZ |
| **France/Spain** | Expand through waste company contract networks | Veolia (EUR 45B), FCC Environment (EUR 4.3B) |

**Phase 3: North America + Asia Expansion (2029-2031)**

| Market | Strategy | Key Partners |
|--------|----------|-------------|
| **United States** | Major market entry via top US waste companies | WM ($25.2B), Republic Services ($16B) |
| **Japan** | Long-term partnership; aging workforce + robot-friendly culture | Japanese distributor/integrator |
| **South Korea** | Smart city programs; technology-receptive market | Local partner |

**Key distribution insight:** Major waste companies (Veolia, Remondis, WM, FCC) hold 7-15 year municipal contracts. A single partnership deal can deploy CleanWalker across dozens of cities simultaneously.
...
### Profitability in Year 3. $27M Revenue by Year 5.

**Five-year revenue and profitability:**

| Year | Units Deployed | Annual Revenue | Total Costs | Net Income | Margin |
|------|---------------|----------------|-------------|------------|--------|
| **Y1** | 10 | $168K | $768K | **-$600K** | -357% |
| **Y2** | 50 | $1.15M | $1.48M | **-$328K** | -29% |
| **Y3** | 200 | **$4.95M** | $3.15M | **+$1.80M** | **+36%** |
| **Y4** | 500 | **$13.02M** | $5.66M | **+$7.36M** | **+57%** |
| **Y5** | 1,000 | **$27.00M** | $9.03M | **+$17.97M** | **+67%** |

**Cumulative P&L turns positive in Year 3** at +$872K. Cumulative profit reaches **+$26.2M** by end of Year 5.

**Key milestones:**

| Milestone | Units | ARR | Significance |
|-----------|-------|-----|-------------|
| Pilot validation | 10 | $336K | Product-market fit confirmed |
| Fleet breakeven | ~28 | ~$1.0M | Monthly operations cash-flow positive |
| Profitability | 50 | $1.86M | Company-level breakeven |
| Series A territory | 200 | $7.92M | Strong margins, proven scale |
| Production scale | 500 | $18.6M | Volume COGS advantages, 57% net margin |

**Unit economics improve dramatically with scale:**

| Volume | COGS/Unit | Unit Breakeven (Standard) | 36-Month Net Profit/Unit |
|--------|-----------|--------------------------|--------------------------|
| 10 units | $14,699 | 4.7 months | $78,118 |
| 100 units | $10,082 | 3.2 months | $103,318 |
| 500 units | $7,976 | 2.5 months | $87,424 (Fleet tier) |
| 1,000 units | $6,963 | 2.2 months | $106,437 |

---

## Slide 13: Team

### Built by MB Software Studio LLC

[PLACEHOLDER: team photo -- headshots of founding team members]

**Founding Team:**

[PLACEHOLDER: CEO bio -- name, background, relevant experience in robotics/software/hardware]

[PLACEHOLDER: CTO bio -- name, background, ML/AI and robotics engineering experience]

[PLACEHOLDER: Head of Hardware bio -- name, background, electromechanical design and manufacturing]

[PLACEHOLDER: Head of ML/Perception bio -- name, background, computer vision and YOLO expertise]

**Company: MB Software Studio LLC**

**Advisory Network:**

[PLACEHOLDER: advisors -- industry experts in municipal waste management, robotics commercialization, and hardware manufacturing]

**What we've built so far:**
- Complete YOLO-based litter detection pipeline trained on 25,000+ images
- Fleet management software architecture
- Full hardware BOM validated with real supplier pricing
- Contract manufacturing partnerships identified (US + EU)
- Detailed financial model validated against industry benchmarks
- Market research across 10+ countries with identified pilot partners
...
| | |
|---|---|
| **Email** | sales@cleanwalkerrobotics.com |
...
- **Municipalities & Property Managers:** Schedule a site assessment and pilot proposal
- **Waste Management Companies:** Explore partnership and deployment across your contract portfolio
- **Investors:** Request our detailed financial model and technical deep-dive

*All figures based on 2026 research and validated supplier pricing. Financial projections use conservative assumptions with 15-20% contingency buffers. Full methodology available upon request.*

---

*CleanWalker Robotics -- Cleaner spaces. Smarter cities. No humans required.*
