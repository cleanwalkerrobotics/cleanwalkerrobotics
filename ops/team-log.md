...
| 2026-02-10 | cw-research | Semantic segmentation SOTA research: 9 models analyzed (SegFormer B0-B5, PIDNet, DDRNet, BiSeNet V2, PP-LiteSeg, OneFormer, Mask2Former, FastSAM, EfficientSAM) for outdoor terrain classification on Jetson Orin Nano Super. 7 terrain datasets reviewed (RUGD, RELLIS-3D, GOOSE, WildScenes, TAS500, YCOR, GANav). Isaac ROS integration mapped. Recommendations: SegFormer-B0 primary, PIDNet-S fallback. Created docs/research/semantic-segmentation-sota-2026.md. | pending |
