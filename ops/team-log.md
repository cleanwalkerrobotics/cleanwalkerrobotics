...
| 2026-02-11 | cw-bizdev | NL grant strategy: WBSO application draft (4 R&D work packages, technical uncertainties, 2000 hrs/yr, cost estimates) + NL funding strategy (7 programs ranked, eligibility assessed, execution roadmap, cumulative €531K-€540K best-case). Files: docs/sales/grants/wbso-application-draft.md, docs/sales/grants/nl-grant-strategy.md | pending |
