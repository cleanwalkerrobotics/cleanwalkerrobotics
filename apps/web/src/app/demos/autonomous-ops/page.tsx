...
const EVENTS_POOL: EventEntry[] = [
	...
	{ time: "08:30", message: "Compactor bin at 45% — collection rate excellent", type: "info" },
	...
	{ time: "13:00", message: "Bin at 72% — compaction ratio holding at 68%", type: "info" },
	...
	{ time: "14:30", message: "Docked — fast charge + bin emptied by maintenance", type: "info" },
